...
function Login() {
  return (
    <div style={{width:'100%',height:'100vh',background:'yellow'}} className="d-flex justify-content-center align-items-center">
      <div style={{width:'900px',height:'500px'}} className="card shadow border rounded p-5 bg-info">
    ...
    <div className="d-flex gap-2">
      <h5>Dont Have an Account?</h5> <a className="text-white" href="">Sign Up</a>
    </div>
                </div>
            </div>
      </div>
